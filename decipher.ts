...
function decipher(text: string, processedPinyin: string, pinyinBuffer: string, usedLetters: string, currentPos: number): void {
    if (quickSkip) {
...
function hasInvalidCombos(text: string): boolean {
